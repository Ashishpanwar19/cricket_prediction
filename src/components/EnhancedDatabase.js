...
export default function EnhancedDatabase() {
  ...
  const fetchTeams = async () => {
    try {
      ...
      setTeams([
        { id: 1, name: 'Mumbai Indians', short_name: 'MI', wins: 140, losses: 80, titles: 5 },
        { id: 2, name: 'Chennai Super Kings', short_name: 'CSK', wins: 130, losses: 80, titles: 4 }
      ]);
    } finally {
      setLoading(false);
    }
  ...
  const fetchPlayers = async () => {
    try {
      ...
      // Fallback to mock data
      setPlayers([
        { id: 1, name: 'Virat Kohli', team_name: 'Royal Challengers Bangalore', role: 'Batsman', runs_scored: 7263, batting_average: 37.25 },
        { id: 2, name: 'Rohit Sharma', team_name: 'Mumbai Indians', role: 'Batsman', runs_scored: 6211, batting_average: 30.35 }
      ]);
    } finally {
      setLoading(false);
    }
  ...
  const fetchMatches = async () => {
    try {
      ...
      // Fallback to mock data
      setMatches([
        { id: 1, team1_name: 'Mumbai Indians', team2_name: 'Chennai Super Kings', team1_score: 185, team2_score: 170, winner_name: 'Mumbai Indians' }
      ]);
    } finally {
      setLoading(false);
    }
